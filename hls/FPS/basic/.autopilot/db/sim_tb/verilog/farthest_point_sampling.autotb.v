...
`define AUTOTB_TVIN_gmem  "./c.farthest_point_sampling.autotvin_gmem.dat"
`define AUTOTB_TVIN_in_r  "./c.farthest_point_sampling.autotvin_in_r.dat"
`define AUTOTB_TVIN_out_r  "./c.farthest_point_sampling.autotvin_out_r.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.farthest_point_sampling.autotvin_gmem.dat"
`define AUTOTB_TVIN_in_r_out_wrapc  "./rtl.farthest_point_sampling.autotvin_in_r.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "./rtl.farthest_point_sampling.autotvin_out_r.dat"
`define AUTOTB_TVOUT_gmem  "./c.farthest_point_sampling.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.farthest_point_sampling.autotvout_gmem.dat"
module `AUTOTB_TOP;
