...
$(ObjDir)/fps_test.c_pre.c.tb.o : fps_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) fps_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/point_aux.c_pre.c.tb.o : point_aux.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) point_aux.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/fps.c_pre.c.tb.o : fps.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) fps.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
