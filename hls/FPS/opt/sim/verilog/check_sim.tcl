...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.farthest_point_sampling.autotvin_gmem.dat"
         "c.farthest_point_sampling.autotvin_in_r.dat"
         "c.farthest_point_sampling.autotvin_out_r.dat"
         "c.farthest_point_sampling.autotvout_gmem.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.farthest_point_sampling.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
