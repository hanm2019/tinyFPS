...
`define AUTOTB_DUT      farthest_point_sampling
`define AUTOTB_DUT_INST AESL_inst_farthest_point_sampling
`define AUTOTB_TOP      apatb_farthest_point_sampling_top
`define AUTOTB_LAT_RESULT_FILE "farthest_point_sampling.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "farthest_point_sampling.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_farthest_point_sampling_top
...
`define AUTOTB_TVIN_gmem  "../tv/cdatafile/c.farthest_point_sampling.autotvin_gmem.dat"
`define AUTOTB_TVIN_in_r  "../tv/cdatafile/c.farthest_point_sampling.autotvin_in_r.dat"
`define AUTOTB_TVIN_out_r  "../tv/cdatafile/c.farthest_point_sampling.autotvin_out_r.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.farthest_point_sampling.autotvin_gmem.dat"
`define AUTOTB_TVIN_in_r_out_wrapc  "../tv/rtldatafile/rtl.farthest_point_sampling.autotvin_in_r.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "../tv/rtldatafile/rtl.farthest_point_sampling.autotvin_out_r.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.farthest_point_sampling.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.farthest_point_sampling.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 68978;
parameter LENGTH_gmem = 1538;
