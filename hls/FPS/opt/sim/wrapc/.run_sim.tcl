...
proc run_exec {fileExe} {
	...
	set ret [catch {eval exec "./$fileExe -disable_dspchk | tee tmp.log" >&@ stdout} err]
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "farthest_point_sampling.autotvin.dat"
	set constFileTvOut       "farthest_point_sampling.autotvout.dat"
	set constFileHdlTvIn     "farthest_point_sampling.autohdltvin.dat"
	set constFileHdlTvOut    "farthest_point_sampling.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
