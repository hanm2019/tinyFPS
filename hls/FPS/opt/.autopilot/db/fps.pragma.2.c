...
# 312 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/etc/autopilot_ssdm_op.h"
...
# 1 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/ap_cint.h" 1
# 84 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/ap_cint.h"
# 1 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/etc/autopilot_apint.h" 1
# 58 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/etc/autopilot_apint.h"
# 1 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/etc/autopilot_dt.h" 1
# 98 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/etc/autopilot_dt.h"
# 1 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/etc/autopilot_dt.def" 1
...
# 99 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/etc/autopilot_dt.h" 2
# 1 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/etc/autopilot_dt_ext.def" 1
...
# 100 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/etc/autopilot_dt.h" 2
# 109 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/etc/autopilot_dt.h"
# 1 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/etc/autopilot_dt.def" 1
...
# 110 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/etc/autopilot_dt.h" 2
# 1 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/etc/autopilot_dt_ext.def" 1
...
# 111 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/etc/autopilot_dt.h" 2
# 132 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/etc/autopilot_dt.h"
typedef int __attribute__ ((bitwidth(64))) int64;
typedef unsigned int __attribute__ ((bitwidth(64))) uint64;
# 59 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/etc/autopilot_apint.h" 2
# 1 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/etc/autopilot_ssdm_bits.h" 1
# 60 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/etc/autopilot_apint.h" 2
# 85 "/opt/Xilinx/Vitis/2020.1/common/technology/autopilot/ap_cint.h" 2
# 4 "./fps.h" 2
...
# 90 "/opt/Xilinx/Vitis/2020.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stddef.h" 3 4
typedef int wchar_t;
...
__attribute__((sdx_kernel("farthest_point_sampling", 0))) void farthest_point_sampling(pointcloud_t*, pointcloud_t*);
...
__attribute__((sdx_kernel("farthest_point_sampling", 0))) void farthest_point_sampling (
      pointcloud_t *in,
      pointcloud_t *out
      )
{
#pragma HLS ARRAY_PARTITION variable=in->points block factor=3 dim=1
# 8 "fps.c"

#pragma HLS ARRAY_PARTITION variable=in->points cyclic factor=64 dim=1
# 8 "fps.c"

#pragma HLS ARRAY_PARTITION variable=out->points block factor=3 dim=1
# 8 "fps.c"

#pragma HLS ARRAY_PARTITION variable=out->points cyclic factor=64 dim=1
# 8 "fps.c"

#pragma HLS TOP name=farthest_point_sampling
# 8 "fps.c"
...
#pragma HLS ARRAY_PARTITION variable=_min_distance.distance_array cyclic factor=64 dim=1
# 14 "fps.c"

#pragma HLS ARRAY_PARTITION variable=_min_distance.distance_mask cyclic factor=64 dim=1
# 14 "fps.c"

 point_distance_array_t *min_distance = &_min_distance;

 point_t _farthest_point;
#pragma HLS ARRAY_PARTITION variable=_farthest_point complete dim=1
# 17 "fps.c"
...
#pragma HLS ARRAY_PARTITION variable=array->distance_array cyclic factor=64 dim=1
# 49 "fps.c"

#pragma HLS ARRAY_PARTITION variable=array->distance_mask cyclic factor=64 dim=1
# 49 "fps.c"
...
#pragma HLS ARRAY_PARTITION variable=origin_point_pix complete dim=1
# 60 "fps.c"


 point_dim_t i,j, max_index;
 point_distance_t p2p_distance, distance_array[3], tmp_distance, min_distance;
#pragma HLS ARRAY_PARTITION variable=distance_array complete dim=1
# 63 "fps.c"
...
point_dim_t max_idx(point_distance_array_t* array){
 ...
 point_distance_t max_distance;
 max_distance = 0;
 VITIS_LOOP_100_1: for(i = 0 ;i < 1024;i++){
  if(array->distance_mask[i] == 1){
