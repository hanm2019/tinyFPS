...
entity farthest_point_sampling_pow_generic_double_s_pow_reduce_anonymous_namespace_log_lut_table_ap_fixed_12dEe_rom is 
    generic(
             DWIDTH     : integer := 105; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 16
...
architecture rtl of farthest_point_sampling_pow_generic_double_s_pow_reduce_anonymous_namespace_log_lut_table_ap_fixed_12dEe_rom is 
...
entity farthest_point_sampling_pow_generic_double_s_pow_reduce_anonymous_namespace_log_lut_table_ap_fixed_12dEe is
    generic (
...
architecture arch of farthest_point_sampling_pow_generic_double_s_pow_reduce_anonymous_namespace_log_lut_table_ap_fixed_12dEe is
    component farthest_point_sampling_pow_generic_double_s_pow_reduce_anonymous_namespace_log_lut_table_ap_fixed_12dEe_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    farthest_point_sampling_pow_generic_double_s_pow_reduce_anonymous_namespace_log_lut_table_ap_fixed_12dEe_rom_U :  component farthest_point_sampling_pow_generic_double_s_pow_reduce_anonymous_namespace_log_lut_table_ap_fixed_12dEe_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
